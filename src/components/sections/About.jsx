      ...
      <div id="about-layout">
        ...
        <div id="obs-frame">
          ...
          <div id="obs-socials">
            ...
            <a className="obs-social-node" href="https://linkedin.com/in/courtneyrgreen" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div id="obs-info">
          ...
          <div id="obs-cards">
            ...
            <div className="asc-card">
              <div className="asc-label">Formation</div>
              <div className="asc-value">MS Data Science &amp; Analytics · Georgetown · 2026</div>
            </div>
            <div className="asc-card">
          ...
          <div id="obs-bio">
            I am a data scientist, policy analyst, and digital storyteller. I explore how data can be harnessed to address complex societal challenges. My work focuses on leveraging advanced analytics and machine learning to develop actionable insights that inform equitable, evidence-based policies. By bridging technical expertise with policy understanding, I aim to create solutions that drive meaningful social impact. Trained to ask not just what the data says, but what it means for people. I am pursuing an M.S. in Data Science &amp; Analytics at Georgetown University, expected May 2026. Currently, I am an Associated Press Elections Web Scraper, and I will be joining Guidehouse as a Tech, Data, &amp; AI Consultant II.
          </div>
        </div>
      </div>
